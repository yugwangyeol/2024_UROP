...
import torchaudio
import os
from models import Generator as NoiseEncoder  # NoiseEncoder를 정의한 파일에서 import

# 경로 설정
wav_name = "contents_4"
model_path = "/home/work/rvc/wavGANattack/checkpoints/generator_E02W08.pth"
input_wav_path = f"/home/work/rvc/FreeVC/voice/content/{wav_name}.wav"
output_wav_dir = "/home/work/rvc/FreeVC/voice/content"
