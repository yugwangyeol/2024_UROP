...
import torchaudio
import os
from model.models import Generator as NoiseEncoder  # NoiseEncoder를 정의한 파일에서 import

# 경로 설정
wav_name = "contents_4"
model_path = "/home/work/rvc/unetAttack/checkpoints/generator.pth"
input_wav_path = f"/home/work/rvc/FreeVC/voice/content/{wav_name}.wav"
output_wav_dir = "/home/work/rvc/unetAttack/output"
...
# 3. 노이즈 적용
with torch.no_grad():
    noisy_waveform = noise_encoder(waveform).to(device)  # [1, num_channels, num_samples]
