...
def vc_infer(contents_audio_path, style_audio_path, smodel, cmodel, net_g, hps, utils):
...
def main():
   ...
   parser.add_argument('--attack_type', type=str, choices=['white', 'black'], default='black',
   ...
   for pair in tqdm(pairs, desc="Processing voice conversion"):
       ...
       # voice conversion 수행
       converted_audio = vc_infer(contents_path, style_path, smodel, cmodel, net_g, hps, vc_utils)
